...
public class CategoryButton extends Button {
    ...
    public void draw() {
        ...
        RenderUtil.drawImage(category.icon, posX + 3f, textY - 1.5f, 12, 12);
        NanoFontLoader.greyCliff.drawString(text, posX + 20f, textY, 15f, Color.WHITE);
    }
