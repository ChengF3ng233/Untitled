...
public class LoginGUI extends MusicPlayerGUI {
    ...
    public boolean draw(float x, float y, int mouseX, int mouseY, float cx, float cy, float scale) {
        ...
        float textY = waitingConfirm ? posY + 30f : posY + 10f;
        ...
        if (waitingConfirm) {
            ...
            NanoFontLoader.misans.drawString(user.getTempNickname(), posX + width / 2f + 13f, posY + 13f, 16f, NanoVG.NVG_ALIGN_CENTER, Color.WHITE);
        }
