...
public class SkidButton {
    ...
    public void draw(float x, float y, int mouseX, int mouseY) {
        ...
        Gui.drawNewRect(-quadsWidth * (1 - xAnim.getOutput().floatValue()), y + height + 7f, quadsWidth, 0.5f, Color.WHITE.getRGB());

        NanoUtil.transformStart(xAnim.getOutput().floatValue() * 5f, 0f);
        NanoFontLoader.script.drawGlowString(text, x + width / 2f, y, 30, 2f, NanoVG.NVG_ALIGN_CENTER, Color.WHITE, Color.WHITE);
