...
public class UntitledMainScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        NanoFontLoader.script.drawGlowString("Untitled Client", centerX, (sr.getScaledHeight() / 2f) * 0.3f, 50f, NanoVG.NVG_ALIGN_CENTER, Color.WHITE, ThemeColor.focusedColor);
        NanoFontLoader.script.drawGlowString("Some birds are not meant to be caged, their feathers are just too bright.", centerX, sr.getScaledHeight() * 0.8f, 25f, NanoVG.NVG_ALIGN_CENTER, Color.WHITE, Color.WHITE);
