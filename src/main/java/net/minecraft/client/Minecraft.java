...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        if (this.serverName != null) {
            this.displayGuiScreen(new GuiConnecting(Client.instance.uiManager.mainScreen, this, this.serverName, this.serverPort));
        } else {
            this.displayGuiScreen(Client.instance.uiManager.mainScreen);
        }
    ...
    public void displayScreen(GuiScreen guiScreenIn) {
        ...
        if (guiScreenIn == null && this.theWorld == null) {
            guiScreenIn = Client.instance.uiManager.mainScreen;
        } else if (guiScreenIn == null && this.thePlayer.getHealth() <= 0.0F) {
            guiScreenIn = new GuiGameOver();
        }

        if (guiScreenIn == Client.instance.uiManager.mainScreen) {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    Client.instance.eventBus.post(keyEvent);
