...
// ------- end test duplicate ---------
    ...
    /**
     * Specifies the weighting factors used by the blend equation, for both RGB and alpha functions and for all render buffers.
     *
    ...
    /**
     * Masks the writing of R, G, B and A values to all render buffers. In the initial state, all color values are enabled for writing for all render buffers.
     *
    ...
    /**
     * Transfers a rectangle of pixel values from one region of the read framebuffer to another in the render framebuffer
     *
    ...
    /**
     * Draws a pixel rectangle to the active render buffers.
     *
     ...
     * clamp its value to the range [0, 2<sup>s</sup> &ndash; 1], where s is the number of bits in the stencil buffer attached to the render framebuffer. The s
